...
class Dashboard {
  ...
  final String mqsAbout = "mqsAbout";
  final String aboutValue = "AboutValue";
  final String mqsAllowAbout = "mqsAllowAbout";
  final String country = "Country";
  final String mqsCountry = "mqsCountry";
  final String countryValue = "CountryValue";
  final String mqsAllowCountry = "mqsAllowCountry";
  final String pronouns = "Pronouns";
  final String mqsPronouns = "mqsPronouns";
  final String pronounsValue = "PronounsValue";
  final String mqsAllowPronouns = "mqsAllowPronouns";
  final String userImage = "UserImage";
  final String mqsUserImage = "mqsUserImage";
  ...
  final String mqsDemoGraphicDetails = "Demographic Details";
  final String mqsDemoGraphicDetailsKey = "mqsDemoGraphicDetails";
  final String mqsWheelOfLifeDetailsKey = "mqsWheelOfLifeDetails";
  final String wOLValue = "wOLValue";
  final String demoGraphicValue = "demoGraphicValue";
  final String mqsScenesDetailsKey = "mqsScenesDetails";
  ...
  final String mqsScenesDetails = "Scenes Details";
  final String mqsWheelOfLifeDetails = "WheelOfLife Details";
  ...
  final String mqsMONGODBUserID = "mqsMONGODBUserID";
...
class Pathway {
  ...
  final String enterPathwayID = "Enter pathway id";
  final String enterPathwayTitle = "Enter pathway title";
  final String enterPathwaySubtitle = "Enter pathway subtitle";
  final String enterAboutPathway = "Enter about pathway";
  final String enterLearningObj = "Enter learning object";
  final String enterPathwayDep = "Enter pathway dep";
  final String enterPathwayCoachInstructions =
      "Enter pathway coach instructions";
  final String enterPathwayDuration = "Enter pathway duration";
  final String enterPathwayLevel = "Enter pathway level";
  final String fundamentals = "Fundamentals";
  final String humanQualities = "Human Qualities";
  final String situations = "Situations";
  final String uploadImage = "Upload Image";
  final String enterModuleTitle = "Enter module title";
  final String enterModuleSubtitle = "Enter module subtitle";
  final String activityTitle = "Activity Title";
  final String activitySubtitle = "Activity Subtitle";
  final String activityAudioLesson = "Activity Audio Lesson";
  final String activityBenefits = "Activity Benefits";
  final String activityCoachInstructions = "Activity Coach Instructions";
  final String activityDuration = "Activity Duration";
  final String activityLessonDetail = "Activity Lesson Detail";
  final String activityReflectionQuestion = "Activity Reflection Question";
  final String activityVideoLesson = "Activity Video Lesson";
  final String mqsInfo = "MQS Info";
  final String navigateToScreen = "Navigate to Screen";
  final String activityUI = "Activity UI";
  final String activitySkills = "Activity Skills";
  final String activitySkill = "Activity Skill";
  final String activityReqIcons = "Activty Request Icons";
