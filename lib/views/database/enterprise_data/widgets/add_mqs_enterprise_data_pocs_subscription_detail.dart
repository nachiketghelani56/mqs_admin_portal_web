...
Widget addMqsEnterpriseDataPOCsSubscriptionDetailWidget(
  ...
  return Column(
    children: [
      ...
      CustomTextField(
        controller: enterpriseDataController.subscriptionActivePlanController,
      ...
      CustomTextField(
        controller: enterpriseDataController.subscriptionStatusController,
      ...
      if (enterpriseDataController.isEditEnterprise.value) ...[
        CustomTextField(
          controller: enterpriseDataController.mqsSubscriptionRenewalDateController,
          ...
          readOnly: true,
          onTap: () async {
            enterpriseDataController.pickRenewalDateTime(context,
                enterpriseDataController.mqsSubscriptionRenewalDateController);
          },
        ),
        SizeConfig.size34.height,
      ],
        ...
        children: [
          Expanded(
            child: CustomTextField(
              controller:
                  enterpriseDataController.mqsSubscriptionStartDateController,
              ...
              validator: (p0) => Validator.emptyValidator(
                  ...
                  StringConfig.dashboard.mqsSubscriptionActivationDate
                      .toLowerCase()),
              onTap: () async {
                enterpriseDataController.pickStartDateTime(context,
                    enterpriseDataController.mqsSubscriptionStartDateController);
              },
            ),
          ),
          ...
          Expanded(
            child: CustomTextField(
              controller:
                  enterpriseDataController.mqsSubscriptionExpiryDateController,
              ...
              validator: (p0) => Validator.emptyValidator(
                  ...
                  StringConfig.dashboard.mqsSubscriptionExpiryDate
                      .toLowerCase()),
              onTap: () async {
                enterpriseDataController.pickExpiryDateTime(context,
                    enterpriseDataController.mqsSubscriptionStartDateController);
              },
            ),
          ),
