    ...
    child: Column(
      children: [
        ...
        if (enterpriseDataController.showMqsEmpEmailList.value) ...[
            ...
            children: [
              Expanded(
                child: CustomTextField(
                  controller: enterpriseDataController.employeeEmailController,
          ...
          SizeConfig.size34.height,
          CustomTextField(
            controller: enterpriseDataController.employeeNameController,
            ...
            children: [
              SizedBox(
                ...
                child: CustomButton(
                  ...
                  onTap: () {
                    enterpriseDataController.clearMqsEmpEmailFields();
                    enterpriseDataController.editMqsEmpEmailIndex.value = -1;
              ...
              SizedBox(
                width: SizeConfig.size162,
                child: CustomButton(
                  btnText: enterpriseDataController.editMqsEmpEmailIndex.value >= 0
                  ...
                  onTap: () {
                    if (entEmpEmailFormKey.currentState
                            ?.validate() ??
                        false) {
                      if (enterpriseDataController.editMqsEmpEmailIndex.value >= 0) {
        ...
        if (enterpriseDataController.mqsEmployeeEmailList.isNotEmpty) ...[
          ...
          for (int i = 0;
            ...
            Container(
              ...
              decoration:
                  i == enterpriseDataController.mqsEmployeeEmailList.length - 1
                ...
                children: [
                  ...
                  Expanded(
                    child: PopupMenuButton<int>(
                      ...
                      onSelected: (value) {
                        if (value == 0) {
                          enterpriseDataController.setMqsEmpEmailForm(index: i);
                        } else if (value == 1) {
                          enterpriseDataController.deleteMqsEmpEmial(index: i);
                        }
                      },
                      itemBuilder: (context) {
                        return [
