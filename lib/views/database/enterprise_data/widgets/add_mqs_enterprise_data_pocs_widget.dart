                ...
                Align(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(
                        top: SizeConfig.size7, left: SizeConfig.size15),
                    child: Text(
                      StringConfig.validation.atLeastOneAdd +
                          StringConfig.dashboard.enterprisePOC +
                          StringConfig.validation.toProceed,
                      style: const TextStyle(
                          color: ColorConfig.validationErrorColor,
                          fontSize: FontSizeConfig.fontSize12_5),
                    ),
                  ),
                ),
                    ...
                    Expanded(
                      child: CustomTextField(
                        ...
                        validator: (p0) => Validator.emptyValidator(p0 ?? "",
                            StringConfig.dashboard.name.toLowerCase()),
                      ),
                    ),
                ...
                Row(
                  children: [
                    Expanded(
                      child: CustomTextField(
                        controller:
                            enterpriseDataController.pocAddressController,
                        label: StringConfig.dashboard.address,
                        hintText: StringConfig.dashboard.enterAddress,
                        validator: (p0) => Validator.emptyValidator(p0 ?? "",
                            StringConfig.dashboard.address.toLowerCase()),
                      ),
                    ),
                    SizeConfig.size24.width,
                    Expanded(
                      child: CustomTextField(
                        controller:
                            enterpriseDataController.pocWebsiteController,
                        label: StringConfig.dashboard.website,
                        hintText: StringConfig.dashboard.enterWebsite,
                        validator: (p0) => Validator.emptyValidator(p0 ?? "",
                            StringConfig.dashboard.website.toLowerCase()),
                      ),
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: CustomTextField(
                        controller:
                            enterpriseDataController.pocPhoneNumberController,
                    ...
                    Expanded(
                      child: CustomTextField(
                        controller:
                            enterpriseDataController.pocPinCodeController,
                        label: StringConfig.dashboard.pinCode,
                        hintText: StringConfig.dashboard.enterPinCode,
                        validator: (p0) => Validator.emptyValidator(p0 ?? "",
                            StringConfig.dashboard.pinCode.toLowerCase()),
                        inputFormatters: [
                          FilteringTextInputFormatter.digitsOnly,
                  ...
                  children: [
                    Expanded(
                      child: CustomTextField(
                        ...
                        validator: (p0) => Validator.emptyValidator(p0 ?? "",
                            StringConfig.dashboard.type.toLowerCase()),
                      ),
                    ),
                    SizeConfig.size24.width,
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: CustomButton(
                        ...
                        onTap: () {
                          enterpriseDataController.clearMqsEntPOCFields();
                          enterpriseDataController.editMqsEntPOCIndex.value =
                              -1;
                    ...
                    SizedBox(
                      ...
                      child: CustomButton(
                        ...
                        onTap: () {
                          if (enterprisePocsFormKey.currentState?.validate() ??
                              false) {
                            if (enterpriseDataController
                                    .editMqsEntPOCIndex.value >=
                                0) {
                  ...
                  return MouseRegion(
                    ...
                    child: Container(
                      ...
                      child: Scrollbar(
                        ...
                        thumbVisibility:
                            enterpriseDataController.isHovering.value,
                            ...
                            children: [
                              ...
                              for (int i = 0;
                                ...
                                Container(
                                  ...
                                  decoration: FontTextStyleConfig
                                      .contentDecoration
                                      .copyWith(
                                      ...
                                      Flexible(
                                        ...
                                        child: PopupMenuButton<int>(
                                          ...
                                          onSelected: (value) {
                                            if (value == 0) {
                                              enterpriseDataController
                                                  .setMqsEnterprisePOCsForm(
                                                      index: i);
                                            } else if (value == 1) {
                                              enterpriseDataController
                                                  .deleteMqsEnterprisePOCs(
                                                      index: i);
                                            }
                                          },
                                          itemBuilder: (context) {
