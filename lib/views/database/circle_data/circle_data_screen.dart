...
import 'package:mqs_admin_portal_web/views/database/widgets/header_navigation_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Padding(
          padding: const EdgeInsets.all( SizeConfig.size20),
          child: headerNavigationWidget(
