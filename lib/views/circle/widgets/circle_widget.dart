...
Widget circleWidget({
  ...
  return Obx(
    () => circleController.circleLoader.value
        ? const LoaderWidget()
        : Row(
            ...
            children: [
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Container(
                    decoration: !(isReport && circleController.circle.isEmpty)
                                  ...
                                  children: [
                                    ...
                                    for (int i = circleController.offset.value;
                                      ...
                                      circleTableRowWidget(
                                        circleController: circleController,
                                        isSelected:
                                            circleController.viewIndex.value ==
                                                i,
                                        context: context,
                                        index: i,
                                        isReport: isReport,
              ...
              if (context.width > SizeConfig.size1500 &&
                ...
                Expanded(
                  child: circleController.isAdd.value ||
