...
//                     flex: SizeConfig.size3.toInt(),
//                     child: Text(
//                       dashboardController.mqsEnterprisePOCs[i].mqsEnterpriseAddress,
...
//                     flex: SizeConfig.size3.toInt(),
//                     child: Text(
//                       dashboardController.mqsEnterprisePOCs[i].mqsEnterpriseEmail,
//                       style: FontTextStyleConfig.tableContentTextStyle,
//                       overflow: TextOverflow.ellipsis,
//                     ),
//                   ),
...
//                     flex: SizeConfig.size2.toInt(),
//                     child: Text(
//                       dashboardController.mqsEnterprisePOCs[i].mqsEnterpriseName,
//                       style: FontTextStyleConfig.tableContentTextStyle,
//                       overflow: TextOverflow.ellipsis,
//                     ),
//                   ),
...
//                     flex: SizeConfig.size2.toInt(),
//                     child: Text(
//                       dashboardController.mqsEnterprisePOCs[i].mqsEnterprisePhoneNumber,
//                       style: FontTextStyleConfig.tableContentTextStyle,
//                       overflow: TextOverflow.ellipsis,
//                     ),
//                   ),
  ...
  return Column(
    children: [
      ...
      CustomTextField(
        ...
        validator: (p0) => Validator.emptyValidator(
            p0 ?? "", StringConfig.dashboard.website),
      ),
      SizeConfig.size34.height,
      Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Expanded(
            ...
            value: dashboardController.isPocsSignedUp.value,
            items: [
              DropdownMenuItem(
                value: true,
                child: Text(
            ...
            onChanged: (val) {
              dashboardController.isPocsSignedUp.value = val;
            },
          )),
          SizeConfig.size24.width,
          Expanded(
        ...
        children: [
          Expanded(
            child: CustomTextField(
              ...
              validator: (p0) => Validator.emptyValidator(
                  p0 ?? "", StringConfig.dashboard.type),
            ),
          ),
          SizeConfig.size24.width,
          Expanded(
